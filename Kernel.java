		...
		case INTERRUPT_SOFTWARE: // System calls
			...
			case READ:
				if (param < 3) {
					...
					if((myTcb = scheduler.getMyTcb()) != null){				
						...
						if (fte != null)									
							return filesys.read( fte, (byte[])args );			
						else 
							return ERROR;
					}
					return ERROR;
			...
			case WRITE:
				if (param < 3) {
					...
					if((myTcb = scheduler.getMyTcb()) != null){				
						FileTableEntry fte = myTcb.getFtEnt(param);			
						if (fte!=null)										
							return filesys.write( fte, (byte[])args );			 
						else
							return ERROR;
					}
					return ERROR;
			...
			case SEEK:    // to be implemented in project
				if((myTcb = scheduler.getMyTcb()) != null ){				
					...
					return filesys.seek(fte, arg[1], arg[2]);					
				}
				return ERROR;
			...
			case FORMAT:  // to be implemented in project
				if((myTcb = scheduler.getMyTcb()) != null ){				
					String[] s = (String[])args;							
					return (filesys.format(param) == true) ? OK:ERROR;								
				}
				return ERROR;

			case DELETE:  // to be implemented in project
				if((myTcb = scheduler.getMyTcb()) != null ){				
					return (filesys.delete((String)args) == true) ? OK:ERROR;	
				}
				return ERROR;
			}
			return ERROR;
